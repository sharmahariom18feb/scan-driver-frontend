...
export const FOOTER_COLUMNS: FooterColumn[] = [
  {
    title: 'Services',
    links: [
      { label: 'Hourly Driver', href: getWhatsAppLink(WHATSAPP_CUSTOMER, 'Hourly Driver'), external: true },
      { label: 'Monthly Driver', href: getWhatsAppLink(WHATSAPP_CUSTOMER, 'Monthly Driver'), external: true },
      { label: 'Weekly Driver', href: getWhatsAppLink(WHATSAPP_CUSTOMER, 'Weekly Driver'), external: true },
      { label: 'Outstation Driver', href: getWhatsAppLink(WHATSAPP_CUSTOMER, 'Outstation Driver'), external: true },
      { label: 'Corporate Driver', href: getWhatsAppLink(WHATSAPP_CUSTOMER, 'Corporate Driver'), external: true },
      { label: 'Airport Transfer', href: getWhatsAppLink(WHATSAPP_CUSTOMER, 'Airport Transfer'), external: true },
      { label: 'Event & Wedding', href: getWhatsAppLink(WHATSAPP_CUSTOMER, 'Event Driver'), external: true },
    ],
  },
  {
    title: 'Company',
